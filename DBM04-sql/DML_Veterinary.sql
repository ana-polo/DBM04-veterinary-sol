...
INSERT INTO pets ( id_pet, pet_name, birth, animal, breed, dangerous_breed, monthly_fee, fk_id_owner )
    VALUES		
		...
		( '102', 'Little', '2019-01-06', 'cat', 'siamese', NULL, 30.5, '1' ),
		( '103', 'Idefix', '2019-05-02', 'dog', 'cocker', NULL, 20.5, '2' ),
		( '104', 'Blue', '2018-01-21', 'dog', 'mastin', FALSE, 20.5, '2' ),
		( '105', 'Socks', '2015-05-18', 'cat', 'siamese', NULL, 30.5, '11' ),
		( '106', 'Ringo', '2017-03-25', 'cat', 'angora', NULL, 30.5, '3' ),
		( '107', 'Lola', ' 2019-08-01', 'dog', 'german shepherd ', FALSE, 20.5, '4' ),
		( '108', 'Shots', '2018-07-21', 'dog', 'podle', FALSE, 20.5, '4' ),
		( '109', 'Sugar', '2010-09-20', 'cat', 'mongrel', NULL, 30.5, '5' ),
		( '110', 'Plas', '2011-09-12', 'cat', 'angora', NULL, 30.5, '5' ),
		...
		( '117', 'Chiqui', '2017-05-08', 'cat', 'angora', NULL, 30.5, '8' ),
		( '118', 'Pearl', '2019-03-08', 'cat', 'angora', NULL, 30.5, '8' ),
		( '119', 'Diamond', '2017-12-25', 'cat', 'angora', NULL, 30.5, '8' ),
		( '120', 'Thunder', '2019-03-05', 'dog', 'pit bull terrier', TRUE, 20.5, '9' ),
		( '121', 'Tato', '2016-02-15', 'cat', 'siamese', NULL, 30.5, '9' ),
		( '122', 'Beltza', '2000-12-12', 'cat', 'angora', NULL, 30.5, '10' ),
		( '123', 'Tintin', '1999-01-23', 'cat', 'mongrel', NULL, 30.5, '2' );
